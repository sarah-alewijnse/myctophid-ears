...
mtext(text = "Ln(Weight) (g)", side = 1, line = 2)
...
par(mfrow = c(1,1))
par(mar=c(4,4,3,3))
plot(M_obs ~ Weight, data = ELC_M_W_list, pch = 16, cex = 1.5, xlab = "", ylab = "", ylim = c(0.15, 0.25), tck = -0.01)
mtext(text = "Ln(Weight) (g)", side = 1, line = 2)
mtext(text = "M Value", side = 2, line = 2)
...
par(mfrow = c(1,1))
par(mar=c(4,4,3,3))
plot(M_obs ~ Weight, data = KRA_M_W_list, pch = 16, cex = 1.5, xlab = "", ylab = "", ylim = c(0.17, 0.35), tck = -0.01)
mtext(text = "ln(Weight) (g)", side = 1, line = 2)
mtext(text = "M Value", side = 2, line = 2)
